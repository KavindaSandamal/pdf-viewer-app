                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="#" className="text-blue-500 hover:text-blue-700"><i className="fab fa-google-plus"></i></a>
                            <a href="#" className="text-blue-500 hover:text-blue-700"><i className="fab fa-youtube"></i></a>
